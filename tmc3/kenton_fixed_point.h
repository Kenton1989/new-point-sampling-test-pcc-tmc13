...
public:
  ...
  explicit operator double() const { return (double)value / DEVISOR; }
  explicit operator float() const { return (float)value / DEVISOR; }
  ...
  __FixedPoint& operator=(const __FixedPoint& a) { value = a.value; return *this; }

  __FixedPoint operator-() const { return __FixedPoint::fromRaw(-value); }

  __FixedPoint& operator+=(const __FixedPoint& a) { value += a.value; return *this; }
  __FixedPoint& operator-=(const __FixedPoint& a) { value -= a.value; return *this; }
  __FixedPoint& operator*=(const __FixedPoint& a) { return *this = *this * a; }
  __FixedPoint& operator/=(const __FixedPoint& a) { return *this = *this / a; }

  friend __FixedPoint operator+(const __FixedPoint& a, const __FixedPoint& b)
  {
  ...
  friend __FixedPoint operator*(const __FixedPoint& a, const __FixedPoint& b)
  {
    return __FixedPoint::fromRaw((UpType)a.getRaw() * b.getRaw() >> DECI_SZ);
  }
  friend __FixedPoint operator/(const __FixedPoint& a, const __FixedPoint& b)
  {
    return __FixedPoint::fromRaw(((UpType)a.getRaw() << DECI_SZ) / b.getRaw());
  }
...
const __FixedPoint<T, U, deciSz, dataSz>
  __FixedPoint<T, U, deciSz, dataSz>::MAX(
    (T(1) << INT_SZ) - 1, (T(1) << DECI_SZ) - 1);
